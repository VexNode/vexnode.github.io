...
const testData = {
  ...
  '11': {
    'matematika': {
      ...
      time: 50,
      questions: [
        { question: 'Kompleks son i² = ?', answers: ['1', '-1', 'i', '-i'], correct: 1 },
        { question: 'i³ = ?', answers: ['1', '-1', 'i', '-i'], correct: 3 },
        { question: 'i⁴ = ?', answers: ['1', '-1', 'i', '-i'], correct: 0 },
        { question: '|z| = √(a²+b²) bu?', answers: ['modul', 'argument', 'qo\'shma', 'haqiqiy qism'], correct: 0 },
        { question: 'Bernulli formulasi?', answers: ['P = C(n,k)p^k qⁿ⁻ᵏ', 'P = n!', 'P = m/n', 'P = a/b'], correct: 0 },
        { question: 'Ehtimollik formulasi?', answers: ['P = m/n', 'P = n/m', 'P = m+n', 'P = m-n'], correct: 0 },
        { question: 'Matematik kutish?', answers: ['M = ∑x_i p_i', 'D = M(x²)-M²(x)', 'σ = √D', 'P = m/n'], correct: 0 },
        { question: 'Dispersiya?', answers: ['M = ∑x_i p_i', 'D = M(x²)-M²(x)', 'σ = √D', 'P = m/n'], correct: 1 },
        { question: 'O\'rta kvadratik chetlanish?', answers: ['M = ∑x_i p_i', 'D = M(x²)-M²(x)', 'σ = √D', 'P = m/n'], correct: 2 },
        { question: 'Kombinatorika n! bu?', answers: ['faktorial', 'son', 'yig\'indi', 'ko\'paytma'], correct: 0 }
      ]
    }
  },
  
  // Kombinatsion test (barcha fanlardan)
  'katta-test': {
...
function loadSubjects(classNum) {
  ...
  if (classTests['matematika']) {
    availableSubjects.push({ 
      ...
      desc: `${classNum}-sinf uchun matematika testlari`
    });
  }
  ...
  if (classTests['ona-tili']) {
    availableSubjects.push({ 
      ...
      desc: `${classNum}-sinf uchun ona tili testlari`
    });
  }
  ...
  if (classTests['ingliz-tili']) {
    availableSubjects.push({ 
      ...
      desc: `${classNum}-sinf uchun ingliz tili testlari`
    });
  }
  ...
  if (classTests['fizika']) {
    availableSubjects.push({ 
      ...
      desc: `${classNum}-sinf uchun fizika testlari`
    });
  }
  ...
  if (classTests['kimyo']) {
    availableSubjects.push({ 
      ...
      desc: `${classNum}-sinf uchun kimyo testlari`
    });
  }
  ...
  if (classTests['biologiya']) {
    availableSubjects.push({ 
      ...
      desc: `${classNum}-sinf uchun biologiya testlari`
    });
  }
